...
- Expanded CSV aliases for Income, Turnover, Buyer, Department, and Timestamp-style schemas.
- Expanded rule-based SQL Explorer coverage for top/bottom limits, business health, data quality, executive summary, decision, recommendation, revenue trend, average revenue, and generic SQL requests.
- Removed stray non-deliverable files from the packaged output.
